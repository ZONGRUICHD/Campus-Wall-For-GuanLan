...
const roleOptions = [
  ...
  { value: 'reviewer', label: '审核员', description: '可审核帖子并发帖，不能添加审核员或修改任何人的权限。' },
  ...
  return (
    <AdminShell title="用户与权限">
      <div className="info-callout mb-5 p-4 text-sm">
        ...
        <div><b>{canManageRoles ? '你可以修改账号角色。' : '角色只能由超级管理员修改。'}</b><p className="mt-1 text-muted">审核员只处理帖子；管理员可管理普通用户与日常运营；超级管理员拥有全部权限。</p></div>
      </div>
